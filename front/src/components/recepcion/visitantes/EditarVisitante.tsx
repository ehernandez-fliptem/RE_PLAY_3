...
const resolver = yup.object().shape({
  ...
  archivo_licencia: yup
    .string()
    .test("isValidLic", "El archivo de licencia es inv�lido.", (value) => {
      if (value) return REGEX_BASE64.test(value);
      return true;
    })
    .when("viene_en_coche", {
  ...
  archivo_poliza_seguro: yup
    .string()
    .test("isValidPoliza", "El archivo de p�liza es inv�lido.", (value) => {
      if (value) return REGEX_BASE64.test(value);
      return true;
    })
    .when("viene_en_coche", {
  ...
  archivo_tarjeta_circulacion: yup
    .string()
    .test("isValidTarjeta", "El archivo de tarjeta es inv�lido.", (value) => {
      if (value) return REGEX_BASE64.test(value);
      return true;
    })
    .notRequired(),
