...
export type FormCitaVisitanteV = {
  // Generales
...
export const resolverCitasV = yup.object().shape({
  tipo_registro: yup
    .number()
    .required("Este campo es obligatorio")
    .min(1)
...
}) as yup.ObjectSchema<FormCitaVisitanteV>;

export const initialValue: FormCitaVisitanteV = {
  tipo_registro: 0,
  visitantes:[],
  id_anfitrion: "",
  accesos: [],
