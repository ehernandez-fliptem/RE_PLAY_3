...
export default function Usuarios() {
  ...
  // [En proceso] Funci√≥n de carga masiva deshabilitada temporalmente
  // const cargaMasiva = () => {
  ...
  const cambiarEstado = async (ID: string, activo: boolean, nombre: string) => {
    if (!activo) {
      confirm({
        title: "øSeguro que deseas restaurar este usuario?",
        description: nombre,
        allowClose: true,
  ...
  const eliminarPermanente = (ID: string, nombre: string) => {
    confirm({
      title: "øSeguro que deseas eliminar permanentemente este usuario?",
      description: nombre,
      allowClose: true,
      confirmationText: "Continuar",
    })
            ...
            <DataGridToolbar
              ...
              customActionButtons={
                <Fragment>
                  ...
                  {/* [En proceso] Bot√≥n de carga masiva oculto porque la funcionalidad a√∫n no est√° disponible
