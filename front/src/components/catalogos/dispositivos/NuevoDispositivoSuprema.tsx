...
export default function NuevoDispositivoSuprema() {
  ...
  const onSubmit: SubmitHandler<FormValues> = async (data) => {
    try {
      ...
      const testRes = await clienteAxios.post(
        "/api/dispositivos-suprema/probar-conexion",
        data
      );
      ...
      const saveRes = await clienteAxios.post("/api/dispositivos-suprema", data);
