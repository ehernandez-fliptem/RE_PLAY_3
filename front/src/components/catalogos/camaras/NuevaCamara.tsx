...
export default function NuevaCamara() {
  ...
  const testConnection: SubmitHandler<FormValues> = async (data) => {
    try {
      const res = await clienteAxios.post(
        "api/camaras/probar-conexion",
        data
      );
      if (res.data.estado) {
        enqueueSnackbar("El cámara se conectó correctamente.", {
          variant: "success",
        });
  ...
  const onSubmit: SubmitHandler<FormValues> = async (data) => {
    try {
      const res = await clienteAxios.post("api/camaras", data);
      if (res.data.estado) {
        enqueueSnackbar("El cámara se creó correctamente.", {
          variant: "success",
        });
