...
router.get("/form-reportes", validarTokenYRol([1, 2, 5, 13]), obtenerFormEventos);
router.get("/form-reporte-horas", validarTokenYRol([1, 2, 5]), obtenerFormReporteHoras);
router.get("/kiosco/paneles", validarTokenYRol([1, 2, 5, 13]), obtenerPanelesKiosco);
router.get("/paneles-alerta-reloj", validarTokenYRol([1], true), obtenerAlertasRelojPaneles);
router.get("/kiosco", validarTokenYRol([1, 2, 5, 13]), obtenerTodosKiosco);
router.get("/imagen/:id", validarTokenYRol([1, 2, 5, 13]), obtenerImagen);
router.get("/:id", validarTokenYRol([1, 2, 5, 13]), obtenerUno);
router.post("/", validarTokenYRol([1, 2, 5, 13]), crear);
...
router.post("/reportes", validarTokenYRol([1, 2, 5, 13]), obtenerTodosPorFiltro);
