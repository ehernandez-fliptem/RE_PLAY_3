...
departamentoSchema.pre<IDepartamento>('save', async function (next) {
    try {
...
const Departamentos: Model<IDepartamento> = mongoose.model<IDepartamento>('departamentos', departamentoSchema);
